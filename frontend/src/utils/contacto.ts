 ...
 * `LandingPage` mantiene su propia lista de contactos comerciales, que es otra
 * cosa: esto es soporte de producto.
 */
export const EMAIL_SOPORTE = 'facundo.arroquy@harasmanager.com'
