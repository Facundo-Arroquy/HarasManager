    ...
    >
      <div className="w-full max-w-lg mx-4 sm:mx-0 rounded-xl border border-zinc-700 bg-zinc-900 shadow-2xl max-h-[90vh] flex flex-col">
        ...
        >
          ...
          {confirmBaja && (
            <div className="rounded-lg border border-rose-800 bg-rose-950/50 p-3 space-y-2">
          ...
          <div>
            {esAdmin && !confirmBaja && (
              <button
                ...
                className="px-3 py-1.5 text-xs text-rose-500 hover:text-rose-300 transition-colors"
              >
                Dar de baja
              </button>
            )}
